...
def cleanup_time(input_csv, num_samples_per_class, output_csv):
    ...
    train_shortened_data = data_cleanup(dataframe, num_samples_per_class)
    ...
    train_no_space_data.to_csv(output_csv, index=False)



cleanup_time('final_train.csv', 1000, "edited_train.csv")

print("shortened and cleaned data now in new csv")
