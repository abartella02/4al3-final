...
def data_cleanup(dataset: pd.DataFrame, amount_per_class: int):
...
def condense_text(data: pd.DataFrame, text_column_name: str):
...
def sample_and_clean(
    ...
    to_csv: bool = False,
    output_csv_path="data/preprocessed.csv",
) -> pd.DataFrame:
